...
<div id="header"><img src="logo_boutique2.png" id="logoimage">
	...
	<div class="navbar">
		...
		<div class="container1">
            <center>
    <table border="1" color="black" cellspacing="15px">
        <tr>
            <th>ID</th>
            <th>NAME</th>
            <th>EMAIL</th>
...
<input class="changeStyle" type="button" value="Message Details"></center></a>                                                
<br>
<a href="index.php"><center>
<input class="changeStyle" style="background-color:maroon;" type="button" value="Log Out"></center></a>
</div>
</div>
</body>
</html>